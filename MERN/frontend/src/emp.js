        ...
        <div className="container mt-4">
            <div className="row">
                ...
                <div className="col-lg-3">
                    <h4 className="text-center">Enter Employee Details</h4>
                    <div className="mb-3">
                    ...
                    <div className="mb-3">
                        ...
                        <input type="text" className="form-control"
                        onChange={obj=>pickDept(obj.target.value)} value={deptname}/>
                    </div>
                    <div className="mb-3">
                        <label>Salary</label>
                        <input type="number" className="form-control"
                        onChange={obj=>pickSalary(obj.target.value)} value={salary}/>
                    </div>
                    <div className="mb-3">
                        <label>City</label>
                        <input type="text" className="form-control"
                                    ...
                                    return(
                                        <tr key={index}>
                                            ...
                                            <td>
                                                ...
                                                onClick={delemp.bind(this, emp._id, emp.empname)}>Delete</button>
                                            </td>
                                        </tr>
                                    )
                                })
